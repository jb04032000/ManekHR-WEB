/**
 * Suspense-level skeleton for the Salary Payments Register page.
 * Mirrors the page layout: header, filter/chip bar, and a payments
 ...
 */
export default function SalaryPaymentsLoading() {
  return (
    <div
      className="mx-auto w-full max-w-7xl animate-pulse p-6"
      role="status"
      aria-busy="true"
      aria-label="Loading salary payments register"
    >
