        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            ...
            <p className="m-0 mt-1 text-sm text-secondary">
              Operational sites where your machines physically run. <strong>Not the same</strong> as
              your registered business address - that stays in Workspace settings and is used on
              payslips and statutory forms.
            </p>
          </div>
          {canManage && (
                      ...
                      render: (_: unknown, row: OperationalLocation) => (
                        <div className="flex justify-end gap-2">
                          ...
                          <Popconfirm
                            ...
                            description="Machines assigned to it will be affected."
