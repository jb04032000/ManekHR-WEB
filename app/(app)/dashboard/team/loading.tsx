export default function TeamLoading() {
  return (
    <div className="w-full animate-pulse">
      ...
      {/* StatTile row skeleton - 4 admin metrics */}
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="rounded-xl border border-[var(--cr-border)] bg-white p-4">
            <div className="mb-2.5 h-3 w-20 rounded bg-gray-100" />
            <div className="mb-1.5 h-7 w-16 rounded bg-gray-100" />
