'use client';
/**
 * Edit/view Sale Order editor page.
 * Route: /dashboard/finance/firms/[firmId]/sales/orders/[id]
 */
...
import type { SaleOrder, SaleInvoice } from '@/types';
...
export default function EditSaleOrderPage({
  ...
  const [voucher, setVoucher] = useState<SaleOrder | null>(null);
